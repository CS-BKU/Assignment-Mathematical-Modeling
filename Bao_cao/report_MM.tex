...
\textbf{Ví dụ \thesubsection.1:} Ta xét các biểu thức sau với A' là "có 10000 đồng", B là "có 1 chai nước suối" và C là "có 1 câu bút bị". Xét biểu thức:\\
\begin{center}
...
\end{center}
Phép $\top$ ở dây được sử dụng để loại bỏ đi lữa chọn mà ta không mong muốn.
...
contract AuctionItem
{
    ...
    function bid() public payable {
        ...
        // Phien dau gia phai dang trong qua tripragma solidity ^0.4.24;
...
contract AuctionItem
{
    ...
    /// Ket thuc phien dau gia, gui tien cho nguoi đem vat pham đi dau gia,
