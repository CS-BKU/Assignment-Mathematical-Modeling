...
Trong linear logic, có cách biểu diễn sự sai - cộng, kí hiệu là $0$ và sự sai nhân, kí hiệu là $\bot$. Mặc dù kí hiệu như vậy, $0$ là phần tử đấy của mạng các giá trị chân lí tuyến tính. (Cụ thể là $0 \vdash \bot$ nhưng $\bot \nvdash 0$).
...
Trong linear logic, có cách biểu diễn sự thật - cộng, kí hiệu là $\top$ và cách biểu diện sự thật - nhân $1$. Như cách kí hiệu, $\top$ là phần tử trên cùng của mạng các giá trị chân lí tuyến tính. (Cụ thể là $1 \vdash \top$ nhưng $\top \nvdash 1$)
...
Trong linear logic đây đủ, có 1 phương thức (modality) kí hiệu là $!$ và được gọi là phương thức số mũ. Nó có vai trò là cho loại tuến tính dạng không tuyến tính. Nó có tên gọi trong tiếng anh là "of coiurse" hay "bang".
...
Torng linear logic cổ điển (có nghĩa với tính hai mặt ngẫu nhiên de Morgan), ký tự de Morgan kép của "!" được biểu diễn là "?" và được gọi là phép toán "why not"
