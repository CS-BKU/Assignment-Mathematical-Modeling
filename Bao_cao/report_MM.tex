...
In linear logic, there is both additive falsity, denoted 0, and multiplicative falsity, denoted ⊥. Despite the notation, it is 0 that is the bottom element of the lattice of linear truth values. (In particular, 0⊢⊥ but ⊥⊬0.)
\subseciton{Chi tiết và ví dụ về phép toán $\top$}
