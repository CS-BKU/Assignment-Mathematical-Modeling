...
## 1. Lịch sử của hợp đồng thông minh (smart contracts)
  Cụm từ "smart contacts" (hợp đồng thông minh) được đặt ra bởi nhà khoa học máy tính và mật mã học Nick Szabo năm 1994 và đã được nghiên cứu qua nhiều năm. Nguyên lý hoạt động của nó được Szabo mô tả năm 1996, rất lâu trước khi công nghệ blockchain ra đời. Theo quan niệm của Szabo, smart contracts là các giao thức cho việc chuyển dịch thông tin sử dụng các giải thuật toán học để thực thi các giao dịch một cách tự động một khi thỏa đầy đủ các điều kiện và dùng để kiểm soát hoàn toàn quá trình này. Định nghĩa này đã đi trước thời đại đến 10 năm và vẫn còn đúng cho đến ngày nay. Nhưng vào những năm 1996, quan niệm về smart contracts vẫn chưa được thừa nhận vì các cộng nghệ cần thiết để vận hành chưa ra đời, đặc biệt là sổ cái phân tán (distributed ledger). <br />
